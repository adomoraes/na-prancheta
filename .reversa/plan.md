# Plano de Exploração — na-prancheta

> Criado pelo Reversa em 2026-09-18
...
- [x] **Arqueólogo** — Análise do módulo `protocolo-vestiario` ✅
- [x] **Arqueólogo** — Análise do módulo `confirmacao-presenca` ✅
- [x] **Arqueólogo** — Análise do módulo `prancheta-tatica` ✅
- [x] **Arqueólogo** — Análise do módulo `tesoureiro-vaquinha` ✅
- [x] **Arqueólogo** — Análise do módulo `scout-pos-jogo` ✅
- [x] **Arqueólogo** — Análise do módulo `almoxarifado-patrimonio` ✅
- [x] **Arqueólogo** — Análise do módulo `onboarding-elenco` ✅
...
- [x] **Redator** — OpenAPI (não aplicável — SPA local-first) ✅
...
- [x] **Revisor** — Resolução de lacunas com o usuário (perguntas em questions.md) ✅
